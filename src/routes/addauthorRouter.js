...
function router(nav) {
    ...
    addauthorRouter.post('/addauthor', upload.single('image'), async (req, res) => {
        var item = {
            name: req.body.name,
    ...
    addauthorRouter.get('/:id/authoreditor', (req, res) => {
        const id = req.params.id;
    ...
    addauthorRouter.post("/:id/authordelete", function (req, res) {
        const id = req.params.id;
    ...
    addauthorRouter.post('/:id/updateAuthor', upload.single('image'), async (req, res) => {
        const id = req.params.id;
        var item = {
